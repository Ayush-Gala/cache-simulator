...
protected:
   ulong tag;
   ulong Flags;    //this is the state of the cache
   ulong seq;     // something to help with eviciton. not important
...
public:
   ...
   void MOESI_Bus_Snoop(ulong addr,int busread,int busreadx, int busupgrade, Cache **cache, int processor);
   void MESI_Bus_Snoop(ulong addr,int busread,int busreadx,int busupgrade, Cache **cache, int processor);
};
